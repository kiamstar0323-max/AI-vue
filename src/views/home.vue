    ...
    <div class="content">
      <div class="text">
         ...
         <div class="hero-actions">
            <router-link to="/consultation"><el-button size="large">开始倾诉，获得陪伴</el-button></router-link>
            <router-link to="/emotion-diary"><el-button size="large" style="border-color: #fff;" color="transparent">记录心情，释放感情</el-button></router-link>
         </div>
      </div>
      <div class="robot">
        <el-image style="width: 150px;" :src="iconUrl" alt="机器人" class="robot-image"></el-image>
      </div>
    </div>
  </div>
</template>
