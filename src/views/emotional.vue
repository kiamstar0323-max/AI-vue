<template>
  <div>
    ...
    <el-pagination style="margin-top: 25px;" :page-size="pagination.size" layout="prev, pager, next" :total="pagination.total" @change="handleChange"></el-pagination>
    <el-dialog
      ...
      <div class="detail-content" v-if="currentDetail">
        ...
        <div class="detail-section">
          ...
          <el-descriptions :column="2" border>
            ...
            <el-descriptions-item label="主要情绪">
              <el-tag :type="getEmotionTagType(currentDetail.emotion)">{{ currentDetail.nickname || '-' }}</el-tag>
            </el-descriptions-item>
        ...
        <div class="detail-section">
          ...
          <el-descriptions :column="1" border>
            <el-descriptions-item label="情绪诱发因素">{{ currentDetail.emotionTriggers || '无' }}</el-descriptions-item>
